import cookie_auth.infrastructure.static_cache as static_cache
import pyramid.renderers
import pyramid.httpexceptions as exc

from cookie_auth.infrastructure.supressor import suppress
import cookie_auth.infrastructure.cookie_auth as cookie_auth
from cookie_auth.services.account_service import AccountService
...
class BaseController:
    def __init__(self, request):
        ...
        layout_render = pyramid.renderers.get_renderer('cookie_auth:templates/shared/_layout.pt')
